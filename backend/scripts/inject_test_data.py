...
async def main() -> None:
    ...
    print(f"   SuperAdmin:   admin@montreal.com / {DEFAULT_PASSWORD}")
    print(f"   Admin:        john.smith@montreal.com / {DEFAULT_PASSWORD}")
    print(f"   Site Manager: mike.wilson@montreal.com / {DEFAULT_PASSWORD}")
    print()
